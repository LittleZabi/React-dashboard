...
export const getPagination = (cookies, url) => {
...
export const life = (__time__) => {
	...
	const mS = (_i) => 'Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sep_Oct_Nov_Dec'.split('_')[_i];
	const dF = (_i) =>
...
export const trimTitle = (title, minchars = 20, lastchars = 7, midchars = '...') => {
...
export const setUserCharName = (name) => {
	const k = name.split(' ');
	let n = '';
...
export const numberFormat = (__num__) => {
