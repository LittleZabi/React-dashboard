...
import { setCookies } from "../utilities/globals";
...
export default ({ setUser_ }: any) => {
    ...
    const handleSubmit = async (e: any) => {
        ...
        try {
            const response = await axios.post(BACKEND_API + '/api/login', {
                usernameOrEmail,
                password,
            });
            setCookies('user', JSON.stringify(response.data.user), { expires: 365 })
